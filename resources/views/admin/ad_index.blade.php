                        ...
                        <div class="row">
                            <div class="col-xl-3 col-6">
                                <div class="content-box">
                                    ...
                                    <div class="chart-num">
                                        <p>Students</p>
                                        <h2 class="font-w700 mb-0">445</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-6">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="user">
                                <div class="user-media">
                                    <img src="/admin_photos/{{session('image')}}" alt="" class="avatar avatar-xxl" style="width:250px; height:250px;">
                                </div>
                                <div>
                                    <h2 class="mb-0">{{$details[0]->name}}</h2>
