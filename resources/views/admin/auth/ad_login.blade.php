...
<head>
    ...
    <meta property="og:title" content="RBDGTC Admin : Hostel management">
    ...
    <!-- Page Title Here -->
    <title>RBDGTC : Hostel management</title>
            ...
            <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                <a href="/">
                    <div class="text-center mb-lg-4 mb-2 pt-5 logo">
                        <img src="assets/img/thotadappa/logo2.png" alt="" style=" width: 200px;">
                    </div>
                </a>
                <h3 class="mb-2 text-white">Welcome back!</h3>
                <p class="mb-4">uses only for<br>Admin</p>
            </div>
        </div>
