...
<div class="nav-header">
    <a href="/adminindex" class="brand-logo">
        <div class="brand-title">
            <svg width="140" height="30" viewBox="0 0 167 30" fill="none">
                <h1 style="color:white" align="center">RBDGTC</h1>
            </svg>
        </div>
    </a>
                        ...
                        <div class="dropdown header-profile2">
                            <a class="nav-link ms-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="header-info2 d-flex align-items-center">
                                    ...
                                    <img src="/admin_photos/{{session('image')}}" alt="">
                                </div>
                            </a>
                                ...
                                <div class="card mb-0">
                                    <div class="card-header p-3">
                                        <ul class="d-flex align-items-center">
                                            <li>
                                                <img src="/admin_photos/{{session('image')}}" class="ms-0" alt="">
                                            </li>
                                            <li class="ms-2">
                                    ...
                                    <div class="card-body p-3">
                                        <a href="/profileshow" class="dropdown-item ai-icon ">
