                ...
                success: function(result) {
                    ...
                    for (i = 0; i < result.length; i++) {
                        htmldata += `<tr>
                                        ...
                                        <td>
                                            <h6 class="mb-0">${result[i].district}</h6>
                                        </td>
                            ...
                            <table id="example" class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer">
                                ...
                                <tbody id="admission_data_div">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="mb-0">{{$dt->district}}</h6>
                                        </td>
                                        <td>
                                            <h6 class="mb-0 text-center">
                                                <a style="margin-right: 10px;" href="/selectreject/{{$dt->application_id}}/Approved"><i class="fa-solid fa-circle-check fa-2xl" data-toggle="tooltip" data-placement="top" title="Approve" style="color: #6ac81e;"></i></a>
                                                <a href="/selectreject/{{$dt->application_id}}/Rejected"><i class="fa-solid fa-circle-xmark fa-2xl" data-toggle="tooltip" data-placement="top" title="Reject" style="color: #db1f1f;"></i></a>
                                            </h6>
                                        </td>
                                        <td class="text-center">
